...
var resetLink = function() {
    ...
    resetTopPopup = function() {
        ...
        if (t && t.length > 0) {
            var e, i, a = $(window).outerHeight();
            t.each(function() {
                e = $(this).find(".container").eq(0).outerHeight(), (i = (a - e) / 2) < 40 && (i = 40), $(this).find(".container").eq(0).css({
                    top: i + "px"
                })
            })
        }
            ...
            if ($(".formHintBubble").remove(), 10 == i.length || 11 == i.length)
                if (10 == (i = i.replace(/[^0-9]/g, "")).length || 11 == i.length);
                    ...
                    var a = $(t).parent().parent(),
                        n = parseFloat($(t).parent().css("top")) - 35,
                        o = $("<span/>").html('<span class="formHintBubble" style="top: ' + n + 'px;">Không phải số điện thoại</span>').contents();
                    a.append(o), $(t).val(i), e = !1
                }
            else {
                a = $(t).parent().parent(), n = parseFloat($(t).parent().css("top")) - 35, o = $("<span/>").html('<span class="formHintBubble" style="top: ' + n + 'px;">Không phải số điện thoại</span>').contents();
                a.append(o), $(t).val(i), e = !1
            }
        }
        return e
    ...
    showPopupLoadPage = function() {
        ...
        t && t.length > 0 && 0 == showpop.loadpage && (t.each(function() {
            ...
            if (e && "1" == e) {
                var a = 0;
                t && parseFloat(t) > 0 && (a = 1e3 * t), setTimeout(function() {
    ...
    actionLink = function(t) {
        if (t && t.length > 0) {
            ...
            a.setAttribute("id", t.attr("id")), a.style.display = "none", document.body.appendChild(a);
            var n = t.attr("lp-target");
            switch (e) {
                case "email":
                    i = "mailto:" + i, a.setAttribute("href", i), a.style.display = "none", a.click(), document.body.removeChild(a);
                    break;
                case "phone":
                    i = "tel:" + i, a.setAttribute("href", i), a.style.display = "none", a.click(), document.body.removeChild(a);
                    break;
                case "page":
                    i = "#" + i;
                    var o = $(i).offset().top;
                    ...
                    break;
                case "url":
                    a.setAttribute("href", i), a.setAttribute("target", n), a.style.display = "none", a.click(), document.body.removeChild(a);
                    break;
                case "popup":
                    var r = $("#" + i);
    ...
    popupForm = function(t, e) {
        ...
        var a = $("#" + e);
        if (a && a.attr("lp-id-pop-sub") && a.attr("lp-id-pop-sub").length > 0) {
            $(".popup.ladi-popup-form").hide(), $('.widget-section[lp-popup="true"]').hide();
            var n = $("#" + a.attr("lp-id-pop-sub"));
            n.find(".container").find(".closePop").remove(), n.find(".container").find(".iframeTks").remove(), n.find(".container").eq(0).append('<div class="closePop" style="top:-25px; right:0;">X</div>'), n.removeClass("lp-hidepopup"), n.addClass("lp-showpopup"), n.css({
                display: "block",
                position: "fixed"
            }), n.removeClass("lazy-hidden"), n.find(".lazy-hidden").removeClass("lazy-hidden"), resetTopPopup(), -1 == n.css("display").search("none") && (scrollTop = $(window).scrollTop(), "true" == ios && $("body").addClass("body-fixed")), runtrackingCus(n), n.find(".closePop").unbind("click").click(function() {
                $("body").removeClass("body-fixed"), $(window).scrollTop(scrollTop), $(this).parent().parent().removeClass("lp-showpopup").hide(), $(this).parent().parent().addClass("lp-hidepopup").hide();
                var t = $(this).parent().parent().find('.widget-element[lp-type="videoyoutube"] .widget-content:eq(0)');
                t && t.length > 0 && t.each(function() {
                    var t = $(this).attr("src");
        ...
        } else if (a.attr("lp-id-pop-url") && a.attr("lp-id-pop-url").length > 0) {
            var o = "";
            if (a.attr("lp-ss-f") && a.attr("lp-ss-f").length > 0) {
                ...
                a.find(".widget-element .widget-content");
                if (o && o.length > 0) {
                    var d = "?",
                        h = a.attr("lp-id-pop-url").split("/");
                    "?" == h[h.length - 1][0] && (d = "&"), o && o.length > 0 && (o = d + o.slice(1, o.length))
                }
            }
            var u = a.attr("lp-id-pop-url") + o;
            window.location.href = u
        } else {
            $(".popup.ladi-popup-form").hide(), $('.widget-section[lp-popup="true"]').hide();
            var m = "";
            m += '<div class="popup ladi-popup-form" data-form="' + e + '" style="display:none;"> <div class="popup-dialog bounceIn animated" style="display: none;"> <div class="popup-header">', m += '<h3 class="popup-title">Thông báo </h3> <button class="close-popup">x</button>', m += '</div> <div class="popup-content">' + i + "</div> </div> </div>", $("body").append(m), $(".ladi-popup-form").show(), $(".ladi-popup-form").css({
                position: "fixed"
...
function countDown(t, e) {
    ...
    function l() {
        var i = endTime(e);
        i.t > 0 ? (a.text(i.d), n.text(i.h), o.text(i.m), r.text(i.s)) : (a.text("00"), n.text("00"), o.text("00"), r.text("00"), clearInterval(s), $(t.attr("lp-show")).addClass("animated fadeInDown").css({
            display: "block"
        }))
    }
    l();
...
function showWatermark(t) {
    if ("1" == t) {
        setInterval(function() {
            $("body").find(".lp-watermart").length > 0 || ($("body").append('<div class="lp-watermart" style="background: #EAEBEE;display: block!important;position: fixed;bottom: 0px;left: 0px;width: 100%; height: 32px;z-index: 9999999999; text-align: center"><a style="width: 100%; height: 100%; display: inline-block;" href="https://ladipage.vn/?utm_source=freemium" target="_blank" rel="nofollow"><img src="https://static.ladipage.net/source/ladipage.png"></a></div>'), $("body").css({
    ...
    void 0 != t && t.length > 0 && t.unbind("click").click(function() {
        ...
        if (void 0 != t && "undefined" != t && "" != t && $("#" + t).length > 0) {
            ...
            if (void 0 != e && e.length > 0) {
                var i = "",
                    a = ($(window).outerHeight() - 600) / 2,
                    n = 600;
                a < 0 && (a = 0, n = $(window).outerHeight()), i = i + '<div class="lp-popup-pub lightbox-image" style="position: fixed;"><div class="container animated fadeIn" style="display:none;"><div class="closePop" style="top:' + (a - 12) + 'px!important;left: -12px!important; padding:0px; padding-left: 6px;">X</div>' + e[0].outerHTML + "</div></div>", $("body").append(i), $(".lightbox-image #" + t).css({
                    width: "100%",
                    height: n + "px",
                    left: "0px",
                    top: a + "px"
...
var AjaxForm = function() {},
    ...
    sendFormClient = function(t, e, i) {
        var a = t.attr("lp-config-client");
        if (a && a.length > 0) {
            a = JSON.parse(a);
            for (var n = 0; n < a.length; n++) switch (a[n].Type) {
                case "api":
                    sendFormClientApi(t, i, a[n].UrlApi);
                    break;
                case "google-form":
                    var o = a[n].Fvv,
                        r = a[n].DraftResponse,
                        ...
                        s = a[n].Fbzx,
                        c = a[n].Action;
                    sendFormClientGoogleForm(t, a[n].List, o, r, l, s, c)
            }
        }
    },
    sendFormClientApi = function(t, e, i) {
        for (var a = {}, n = 0; n < e.length; n++) e[n].idName ? a[e[n].idName] = e[n].value : a[e[n].key] = e[n].value;
        ...
        a.link = p, o && o.length > 0 && (a.utm_source = o), r && r.length > 0 && (a.utm_medium = r), l && l.length > 0 && (a.utm_campaign = l), s && s.length > 0 && (a.utm_term = s), c && c.length > 0 && (a.utm_content = c), $.ajax({
            type: "POST",
            url: i,
    ...
    sendFormClientGoogleForm = function(t, e, i, a, n, o, r) {
        var l = {},
            s = "";
        if (l.fvv = i, l.draftResponse = a, l.pageHistory = n, l.fbzx = o, e && e.length > 0) {
...
AjaxForm.prototype.sendValue = function(t, e, i, a, n) {
    var o = t.attr("lp-type-form"),
        r = $('.widget-element[lp-parent="' + t.attr("id") + '"]'),
        l = r.find(".widget-content").eq(0).html();
    if (r.attr("lp-value-text", l), r.find(".widget-content").eq(0).text("Vui lòng đợi"), t.attr("id-conf-sv") && t.attr("id-conf-sv").length > 0 || t.attr("lp-config-client") && t.attr("lp-config-client").length > 0) t.attr("id-conf-sv") && t.attr("id-conf-sv").length > 0 && (checkForm.countForm++, sendFormServer(t, a, i)), t.attr("lp-config-client") && t.attr("lp-config-client").length > 0 && (checkForm.countForm++, sendFormClient(t, a, i));
    else if (t.attr("lp-action") && t.attr("lp-action").length > 0) switch (o) {
        case "pc":
            checkForm.countForm++, this.saveFormPc(t, e, i, a, n);
            break;
        case "google":
        ...
        popupForm("Đã xảy ra lỗi, vui lòng kiểm tra lại! Hoặc liên hệ với chúng tôi để được hỗ trợ!", t.attr("id")), t.find(".widget-element .widget-content").val("");
    ...
    var c = setInterval(function() {
        if (checkForm.countTo == checkForm.countForm && 0 != checkForm.countForm) {
            ...
            else popupForm("Đã xảy ra lỗi, vui lòng kiểm tra lại! Hoặc liên hệ với chúng tôi để được hỗ trợ!", t.attr("id")), t.find(".widget-element .widget-content").val(""), (e = $('.widget-element[lp-parent="' + t.attr("id") + '"]')).find(".widget-content").eq(0).html(e.attr("lp-value-text"));
            checkForm.countForm = 0, checkForm.countTo = 0, checkForm.value = "false"
        }
    }, 200)
}, AjaxForm.prototype.saveApi = function(t) {
    for (var e = t.find(".widget-content:eq(0) .widget-element"), i = {}, a = JSON.parse(t.attr("lp-data-form")), n = 0; n < a.length; n++) e.each(function(t) {
        if (a[n].name == $(this).find(".widget-content").eq(0).attr("name"))
            ...
            } else i[a[n].value] = $(this).find(".widget-content").eq(0).val()
    });
    var o = getUtm("utm_source"),
        r = getUtm("utm_medium"),
        l = getUtm("utm_campaign"),
        ...
        if (e && e.length > 0 && (i = [], e.each(function() {
            ...
            for (var n = 0; n < i.length; n++)
                for (var o = 0; o < i.length; o++)
                    if (i[n].top < i[o].top) {
                        var r = {};
                        r.top = i[o].top, r.name = i[o].name, r.value = i[o].value, i[o].top = i[n].top, i[o].name = i[n].name, i[o].value = i[n].value, i[n].top = r.top, i[n].name = r.name, i[n].value = r.value
    ...
    var e, i = JSON.parse(t.attr("lp-data-form")),
        a = t.find(".widget-content:eq(0) .widget-element"),
        n = {},
        o = "";
    (e = i.itemsSave && i.itemsSave.length > 0 ? i.itemsSave : i.items) && e.length > 0 ? (a.each(function(t) {
        for (var i = 0; i < e.length; i++)
            if (o += $(this).find(".widget-content").eq(0).val(), $(this).find(".widget-content").eq(0).attr("name") == e[i].nameFormUser) {
                n[e[i].id] = $(this).find(".widget-content").eq(0).val();
                break
            }
    }), n.fvv = i.fvv, n.draftResponse = i.draftResponse, n.pageHistory = i.pageHistory, n.fbzx = i.fbzx, o ? this.senForm(n, t, i.action) : popupForm("Vui lòng điền thông tin không được để trống!", "ladi-check-value")) : popupForm("Chưa gửi được thông tin. Vui lòng liên hệ trực tiếp với chúng tôi!", "ladi-check-value")
    ...
    this.senForm(e, t, i)
}, AjaxForm.prototype.saveFormPc = function(t, e, i, a, n) {
    var o = {
        formid: e,
        listcontact: i,
        ladipageid: a,
    ...
    var n = t.attr("lp-action"),
        o = {
            ...
            text: "Dữ liệu:",
            html: i + "<br>Dữ liệu từ: " + window.location.href,
            id: $("head .title-site").attr("lp-id")
        };
    n && n.length > 0 && -1 != n.search("https://docs.google.com/forms") || n && n.length > 0 && -1 != n.search("https://goo.gl/forms") ? this.google(t) : a ? $.ajax({
        type: "POST",
    ...
    }) : popupForm("Vui lòng điền dữ liệu trước khi gửi!", t.attr("id"))
    ...
    if (i && i.length > 0) {
        var a = $('.widget-element[lp-parent="' + e.attr("id") + '"]');
        a && a.length > 0 && "popup" == a.attr("lp-action-type") && $("#" + a.attr("lp-action-link")), $.ajax({
            type: "POST",
            url: i,
            data: t,
            success: function(t) {
    ...
    checkfont = function() {
        ...
        1 != e && $(window).outerWidth() < 768 && $(".widget-content").each(function() {
            var t = parseFloat($(this).css("font-size")),
                ...
                a = parseFloat(t * e * e).toFixed(4),
                n = parseFloat(i * e * e).toFixed(4);
            $(this).css("font-size", parseFloat(a)), $(this).css("line-height", parseFloat(n) + "px")
        })
    },
                ...
                if (inputRequired && inputRequired.length > 0) inputRequired.each(function(t) {
                    if (!this.validity.valid) {
                        ...
                        var e = formTarget.find(".widget-content:eq(0)"),
                            i = $(this),
                            a = i.get(0),
                            n = (i.position(), a.validationMessage || "Invalid value."),
                            o = parseFloat($(this).parent().css("top")) - 35,
                            r = $(this).parent().css("left"),
                            l = $(this).parent().css("width"),
                            s = $("<span/>").html('<span class="formHintBubble" style="top: ' + o + "px;left:" + r + ";width:" + l + ';">' + n + "</span>").contents();
            ...
            e.each(function() {
                ...
                e && e.length > 0 && -1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && e.each(function() {
                    var e = $(this).offset().top,
                        i = $(this).outerHeight(); - 1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && (e + i < t || e > t + a || ($(this).hide(), "fixed" != $(this).css("position") && $(this).hasClass("widget-element") && "true" == $(this).attr("lp-popup") || $(this).show(), LP_DOC.arrAnimate.push($(this).attr("id"))))
                })
            });
            var n = $('[lp-ani!=""]');
            n && n.length > 0 && n.each(function() {
                ...
                if (e && e.length > 0) {
                    var i = $(this).offset().top,
                        n = $(this).outerHeight(); - 1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && (i + n < t || i > t + a || ("fixed" != $(this).css("position") && $(this).hasClass("widget-element") && "true" == $(this).attr("lp-popup") || $(this).addClass(e), LP_DOC.arrAnimate.push($(this).attr("id"))))
                }
            }), stickyRun()
        }
    },
...
LadiApp.prototype.init = function() {
    ...
    if (t && t.length > 0) {
        var e = "",
            a = "";
        t.each(function() {
            e = $(this).attr("lp-type"), a = $(this).attr("lp-action-link");
            var t = $(this).attr("lp-tracking");
            if ("customhtml" != e && a && a.length > 0) {
    ...
    $(window).on("mousewheel", function(t) {
        ...
        var n = $('.widget-section[lp-popup="true"]:visible');
        n && n.length > 0 || (runAdimate(), runAnimateSection(), stickyRun()), runAnimateSection();
    ...
    var n = $('.widget-section[lp-popup="true"]');
    n && n.length, n.on("scroll", function(t) {
        ...
        var e = $(window).scrollTop(),
            i = $('.widget-section[lp-popup = "true"]:visible'),
            a = $('.widget-section[lp-popup != "true"]');
        if (a && a.length > 0) {
...
var stickyRun = function() {
        var t, e, i, a, n = $('[lp-sticky="1"]'),
            o = $(window).scrollTop(),
            r = $(window).outerHeight();
        n && n.length > 0 && n.each(function() {
            i = $(this).attr("lp-style-offset-left") + "px", a = parseFloat($(this).attr("lp-style-offset-top")), t = $(this).attr("lp-sticky-pos"), e = parseFloat($(this).attr("lp-sticky-kc")), o > a || o + r < a ? ($(this).css({
                position: "fixed",
                "z-index": "9999"
    ...
    sapxepphantuform = function(t) {
        if ($('.widget-element[lp-type="button"][lp-parent="' + t.attr("id") + '"]').css({
            ...
            for (var e = JSON.parse(t.attr("lp-vt-item")), i = 0; i < e.length; i++) {
                var a = t.find('.widget-content:eq(0) .widget-element[lp-type="item_form"]');
                if ($("#" + e[i].id).insertBefore(a.eq(e[i].vt)), i == e.length - 1) return !0
            } else {
                e = [];
                var n = t.find('.widget-element[lp-type="item_form"]');
        ...
        t && t.length > 0 && t.each(function() {
            ...
            if ($('.widget-element[lp-type="button"][lp-parent="' + $(this).attr("id") + '"]').css({
                ...
                for (var e = JSON.parse($(this).attr("lp-vt-item")), i = 0; i < e.length; i++) {
                    var a = $("#" + t).find('.widget-content:eq(0) .widget-element[lp-type="item_form"]');
                    t == $("#" + e[i].id).parent().parent().attr("id") && $("#" + e[i].id).insertBefore(a.eq(e[i].vt))
                } else {
                    e = [];
                    var n = $(this).find('.widget-element[lp-type="item_form"]');
...
function ladinotify() {
    ...
    (t = jQuery).fn.ladiNotify = function(e) {
        var i = t.extend({
            ...
            a = "https://static.ladipage.net/source/notify.svg",
            n = [{
                key: "gsx$title",
                className: ".nttitle"
            }, {
...
function ladicarousel() {
    ...
    (t = jQuery).fn.ladiCarousel = function(e) {
        ...
        this.each(function() {
            var e = t(this),
                a = e.width(),
                n = a * (e.find(".widget-item-child").length - 1),
                o = e.find(".wrap-child");
            ...
            function c() {
                0 == r ? s.hide(300) : s.show(300), r == -n ? l.hide(300) : l.show(300)
            }
            c(), l.on("click", function() {
                r > -n && (r -= a, o.css("left", r), c())
            }), s.on("click", function() {
                r < 0 && (r += a, o.css("left", r), c())
            ...
            u && setInterval(function() {
                r == -n ? (r = 0, o.css("left", r), c()) : l.click()
            ...
            function v(t) {
                g && (h = parseFloat(o.css("left"))) <= 0 && h >= -n && (d = "touchmove" == t.type ? t.originalEvent.touches[0].pageX : t.pageX, (h = r + (d - p)) <= 0 && h >= -n && o.css("left", h))
            }

            function w(t) {
                if (o.addClass("animatecarousel"), 0 != d) {
                    var e = d - p;
                    h <= 0 && h >= -n && Math.abs(e) >= 10 && (e > 0 ? r += a : r -= a), o.css("left", r), c()
                }
                g = !1, d = 0
            }
        })
...
function ladireadmore() {
    var t;
    (t = jQuery).fn.ladiReadmore = function(e) {
        t.extend({}, e), this.each(function() {
            var e = t(this),
                i = e.data("readmore").heightDesktop,
                a = e.data("readmore").heightMobile,
                n = parseFloat(e.css("height")),
                o = i;
            if (screen.width < 768 && (o = a), Boolean(o)) {
                e.css({
                    height: o + 48,
                    overflow: "hidden"
                ...
                r.addClass("show").css("top", o), r.on("click", function() {
                    t(".sectionanimate").removeClass("sectionanimate"), e.addClass("sectionanimate").css("height", n), r.addClass("hidden")
                })
            }
        })
    }, $(".ladi-readmore").ladiReadmore()
}
...
function ladianimatedheadline() {
    ...
    (t = jQuery).fn.ladiHeadline = function(e) {
        ...
        this.each(function() {
            ...
            if (t.each(p, function(t, e) {
                    if ("ladi-animated-headline" === e) return a.animationType = p[t + 1], !1
    ...
    }, $(".ladi-animated-headline").ladiHeadline()
}
